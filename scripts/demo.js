...
const { proposal } = await request(path + '/proposals', 'POST', { teamName: 'Demo Students', contact: 'students@example.test', plan:'Build and test', deadline:'2 weeks', prototypeLink:'https://example.test/prototype', message: 'Демо прототип ұсынамыз.' });
